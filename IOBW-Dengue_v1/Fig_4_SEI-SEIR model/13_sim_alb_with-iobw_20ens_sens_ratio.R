...
dir.create("02_output/02_sim-alb_with-iobw_sens")

#================================================================================
Combnation <- read_csv("02_output/20_best_comb_alb.csv")
...
for (i in 1:11) {
  ...
  write.csv(sim_all, paste0("02_output/02_sim-alb_with-iobw_sens/", i, "_", countrys[i], "_ratio.csv"))
