...
dir.create("02_output/02_sim-alb_with-iobw")
...
# Initial scale
init.cond <- read_csv("01_data/03_init.cond.csv")
# Thermal response parameters
trait_posterior <- read_csv("01_data/05_alb_traits.csv")
...
for (i in target_country) {
  ...
  write.csv(sim_all, paste0("02_output/02_sim-alb_with-iobw/", i, "_", countrys[i], ".csv"))
