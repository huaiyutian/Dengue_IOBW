...
#===============================================================================
ir_data<-read.csv('02_output/15_alb_with_iobw_sens_ID.csv')
# Research Country
countrys <- unique(ir_data$country)

dir.create("02_output/04_sim_id_alb")
result_all_id <- c()
for (i in 1:length(countrys)){
  ...
  ir_sim_id_p
  file_name = paste("02_output/04_sim_id_alb/",i,"_",countrys[i],".pdf",sep="")
...
write.csv(result_all_id,"02_output/04_sim_id_alb/01_sim_id_alb.csv")

#===============================================================================
# plot 2: IC sensitivity analysis
#===============================================================================
ir_data<-read.csv('02_output/16_alb_with_iobw_sens_IC.csv')
# Research Country
countrys <- unique(ir_data$country)

dir.create("02_output/05_sim_ic_alb")
result_all_ic <- c()
...
for (i in 1:length(countrys)){
  ...
  ir_sim_ic_p <- ir_sim_ic_95 %>%
    ...
    theme(plot.margin=unit(rep(1,4),'lines'))
  ir_sim_ic_p
  file_name = paste("02_output/05_sim_ic_alb/",i,"_",countrys[i],".pdf",sep="")
...
write.csv(result_all_ic,"02_output/05_sim_ic_alb/02_sim_ic_alb.csv")

#===============================================================================
# plot 3: ratio sensitivity analysis
#===============================================================================
ir_data<-read.csv('02_output/17_alb_with_iobw_sens_ratio.csv')
# Research Country
countrys <- unique(ir_data$country)

dir.create("02_output/06_sim_ratio_alb")
result_all_ratio <- c()
...
for (i in 1:length(countrys)){
  ...
  ir_sim_ratio_p <- ir_sim_ratio_95 %>%
    ...
    theme(plot.margin=unit(rep(1,4),'lines'))
  ir_sim_ratio_p
  file_name = paste("06_sim_ratio_alb/",i,"_",countrys[i],".pdf",sep="")
...
write.csv(result_all_ratio,"02_output/06_sim_ratio_alb/03_sim_ratio_alb.csv")
