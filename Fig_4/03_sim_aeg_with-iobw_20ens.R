...
dir.create("02_output/01_sim-aeg_with-iobw")
...
trait_posterior <- read_csv("01_data/04_aeg_traits.csv")
...
for (i in target_country) {
  ...
  write.csv(sim_all, paste("02_output/01_sim-aeg_with-iobw/", i, "_", countrys[i], ".csv"))
}
